...
import { RegisterErrorResponseDto,LoginErrorResponseDto } from './dto/members-error-response.dto';
...
@Post('register')
  ...
  @ApiResponse({ status: 409, description: '註冊失敗', type: RegisterErrorResponseDto })
...
@Post('login')
  ...
  @ApiResponse({ status: 401, description: '登入失敗', type: LoginErrorResponseDto })
